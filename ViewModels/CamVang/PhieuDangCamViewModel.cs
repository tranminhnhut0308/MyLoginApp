...
public class PhieuDangCamViewModel : ObservableObject
{
    ...
    public decimal TongCanTong
    {
        ...
        set
        {
            if (SetProperty(ref tongCanTong, value))
            {
                ...
                OnPropertyChanged(nameof(TongCanTongInLuong));
            }
        }
    }
    ...
    public decimal TongTLHot
    {
        ...
        set 
        {
            ...
            {
                OnPropertyChanged(nameof(TongTLHotInLuong));
            }
        }
    }
    public decimal TongTLThuc
    {
        ...
        set
        {
            if(SetProperty(ref tongTLThuc, value))
            {
                OnPropertyChanged(nameof(TongTLThucInLuong));
            }
        }
    }
    ...
    public decimal TongCanTongInLuong => TongCanTong / 1000m;
    public decimal TongTLHotInLuong => TongTLHot / 1000m;
    public decimal TongTLThucInLuong => TongTLThuc / 1000m;
